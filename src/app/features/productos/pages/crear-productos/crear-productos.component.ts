...
import { ProductoCreateRequest } from '../../../../core/models/producto.interface';
...
export class CrearProductosComponent implements OnInit, OnDestroy {
  ...
  onSubmit(): void {
    ...
    this.productosService.crear(productoData)
      .pipe(
        takeUntil(this.destroy$),
        catchError(error => {
  ...
  get isFormReady(): boolean {
    return this.productoForm.valid && !this.isLoading() && !this.loadingCategorias();
  }
